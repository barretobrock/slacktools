...
from slacktools.api.events.user_change import UserChange
...
class TestUserChangeEvent(unittest.TestCase):
    ...
    def test_user_change(self):
        ...
        for scen, scen_dict in scenarios.items():
            ...
            resp = UserChange(event_dict=build_mock_user_change_resp(
                real_name='something',
                display_name='quicker',
                status_text=new_status
            ))
            self.assertEqual(new_status, resp.profile.status_text)
